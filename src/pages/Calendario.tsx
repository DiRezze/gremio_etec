...
const Calendario = () => {
    ...
    const eventosOrdenados = useMemo(() => {
        if (mostrarPassados) {
            return getEventosPassados(eventosAtuais).sort((a, b) => new Date(b.data).getTime() - new Date(a.data).getTime());
        } else {
                ...
                <section className="overflow-x-clip">
                    <div className="flex flex-row flex-wrap gap-2">
                        ...
                        <Button
                            ...
                            className="rounded-full"
                            onClick={() =>{
                                 setEventosAtuais(getEventosPassados([...vestibulares, ...olimpiadas, ...internos]));
